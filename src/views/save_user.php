    ...
    <form action="#" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="password" name="confirm_password" placeholder="Confirmação de senha" class="form-control <?= $errors['confirm_password'] ? 'is-invalid' : '' ?>">
                <div class="invalid-feedback">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="checkbox" id="is_admin" name="is_admin" class="<?= $errors['is_admin'] ? 'is-invalid' : '' ?>" <?= $is_admin ? 'checked' : '' ?>>
                <div class="invalid-feedback">
                    <?= $errors['is_admin'] ?>
                </div>
            </div>
